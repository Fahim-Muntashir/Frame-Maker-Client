        ...
        <div className="lg:flex lg:items-start lg:gap-2">
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            <div className="col-span-2">
              <div>
                ...
                <p className="mt-4 text-gray-500 dark:text-gray-400">
                  Located in a picturesque setting, our institution boasts
                  state-of-the-art facilities designed to stimulate imagination
                  and inspire innovation. As you step into our campus, you'll
            ...
            <div className="col-span-2 sm:col-span-1">
              <p className="font-medium text-white-900 dark:text-white">
                Courses
              </p>
        ...
        <div className="mt-8 border-t border-gray-100 pt-8 dark:border-gray-800">
          <div className="sm:flex sm:justify-between">
            <p className="text-xs text-gray-500 dark:text-gray-400">
              &copy; 2023. FrameMaker. All rights reserved.
            </p>
